...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" ItemType="E_Commerce_Team3.Prodotto" Visible="true" AutoGenerateColumns="false" CssClass="table table-condensed table-hover w-100">
        <Columns>
