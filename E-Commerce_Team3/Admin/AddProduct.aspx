    ...
    <div class="container w-50" id="FormAdd">
                ...
                <div class="row">
                    <div class="col pb-5">                   
                            ...
                            <asp:Button ID="InsertProdotto" runat="server" Text="Aggiungi prodotto" OnClick="InsertProdotto_Click" CssClass="btn btn-primary w-50" />
                            <asp:Button ID="Annulla" runat="server" Text="Annulla" OnClick="Annulla_Click" CssClass="btn btn-secondary w-50" />
                        </div>
                       </div>
                    </div>
            </div>
